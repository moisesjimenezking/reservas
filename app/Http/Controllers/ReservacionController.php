...
class ReservacionController extends Controller
{
    ...
    /**
     * General list of reservations by date, grouped by location and section.
     */
    ...
    public function downloadPdf(Reserva $reserva): \Symfony\Component\HttpFoundation\BinaryFileResponse  | \Illuminate\Http\RedirectResponse
    {
        ...
        $pdfPath = storage_path('app/private/receipt_' . $reserva->id . '.pdf');
        $pdf->Output($pdfPath, 'F');

        return Response::download(
            $pdfPath, 'comprobante_' . $reserva->id . '.pdf',
